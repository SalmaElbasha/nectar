...
import '../../ui/auth/get_product/get_bakeries_and_snacks_controller.dart';
import '../../ui/auth/get_product/get_fruits_and_vegetables.dart';
import '../../ui/auth/get_product/get_groceries_controller.dart';
import '../../widgets/Beverages_widget/Beverages_widget.dart';
import '../product_details_screen/prdouct_details.dart';


class BakeriesAndSnacksScreen extends StatelessWidget {
  const BakeriesAndSnacksScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: GetBakeriesAndSnacksController(),
        builder: (GetBakeriesAndSnacksController controller) {
          return Scaffold(
            appBar: AppBar(
              toolbarHeight: 60,
              leading: IconButton(
