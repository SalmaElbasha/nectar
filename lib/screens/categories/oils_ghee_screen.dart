...
import 'package:nectar/ui/auth/get_product/get_oils_controller.dart';

import '../../ui/auth/get_product/get_beverages_controller.dart';
...
class OilsGheeScreen extends StatelessWidget {
  const OilsGheeScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: GetOilsController(),
        builder: (GetOilsController controller) {
          return Scaffold(
            appBar: AppBar(
              toolbarHeight: 60,
              leading: IconButton(
